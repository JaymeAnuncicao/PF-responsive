...
<body>
    ...
    <a href="/php/Login/login.php" class="back1"><button class="float-right z-depth-2 mt-4 mr-5 press blue darken-4 press-xl press-circle back1"><i class="fas text-white fa-arrow-left"></i></button></a>
    <div class="container adm-serv">
    ...
    <a href="/php/Login/login.php" class="back2"><button class="float-right z-depth-2 mt-4 mr-5 press blue darken-4 press-xl press-circle "><i class="fas text-white fa-arrow-left"></i></button></a>
...
<?php
    if(isset($_POST['peca'], $_POST['preco'], $_POST['comentario'])){
        ...
        $query = 'INSERT INTO andamento (peca ,dia, comentario, preco,) VALUES (:peca, :dia, :comentario, :preco);';
