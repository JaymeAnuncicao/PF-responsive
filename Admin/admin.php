...
<body>
    ...
    <div class="adm">
        <div class="ml-5 container col-6 float-left monitorar">
            <div class="row">
        ...
        <div class="col-md-6 mt-5 mr-5 col-lg-4 float-right container ">
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" class="z-depth-3 text-center rounded primary-color-dark p-5 add-news">
